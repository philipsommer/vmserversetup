...
Vagrant::Config.run do |config|
 ...
 config.vm.define :allinone do |base_config|
 ...
 config.vm.define :jetty do |base_config|
 ...
 config.vm.define :mongo do |base_config|
...
#  config.vm.define :rtd do |rtd_config|
#      rtd_config.vm.forward_port 3306, 3306
#  end
